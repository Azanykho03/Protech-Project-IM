...
<head>
  ...
  <body>
        ...
        <section id="hero">
          ...
          <!-- Services Section with Image Popup -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="contact-form">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <input type="text" class="form-control form-control-lg shadow-sm" placeholder="First Name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control form-control-lg shadow-sm" placeholder="Last Name">
                                </div>
                                <div class="col-12">
                                    <input type="email" class="form-control form-control-lg shadow-sm" placeholder="Email Address">
                                </div>
                                <div class="col-12">
                                    <input type="tel" class="form-control form-control-lg shadow-sm" placeholder="Phone Number">
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control form-control-lg shadow-sm" rows="4" placeholder="Message"></textarea>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-danger btn-lg w-100 shadow-sm">Send Message</button>
                                </div>
                            </div>
                        </div>
                    </div>
